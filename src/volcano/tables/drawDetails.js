export default function drawDetails(datum) {
    ...
    const
        infoHeader = this.details.table.select('tbody')
            .append('tr')
            .append('td')
            .classed('header', true)
            .attr({
        ...
        infoRows = this.details.table.select('tbody')
            .selectAll('tr.info')
                .data(this.details.variables)
                .enter()
            .append('tr')
            .classed('info', true),
        statsHeader = this.details.table.select('tbody')
            .append('tr')
            .append('td')
            .classed('header', true)
            .attr({
            ...
            .text('Risk Ratios'),
        statsRows = this.details.table.select('tbody')
            .selectAll('tr.stats')
