...
function layout$2() {
    ...
    this.selected.wrap.append('div').classed('title', true).html('Selected Taxa (n=<span class = "nSelected">0</span>)');
...
function drawDetails(datum) {
    ...
    if (datum) {
        ...
        var infoHeader = this.details.table.select('tbody').append('tr').classed('header', true).attr('id', 'info-header').append('td').attr('colspan', 2).text('Taxa Information'),
